...
% open new figure
fig2_file = 'PZ_tool_figure.fig';
fig2 = openfig(fig2_file,'reuse');
optional_uicontrols = { ...
    'Apply_radiobutton', 'Value'; ...
    'Pan_radiobutton',   'Value'; ...
    'Zoom_radiobutton',  'Value'; ...
                   };
...
if apply_all
    ...
    set(fig, 'CurrentAxes', userdata{6});
    set(0,'CurrentFigure', fig);
    myzoom(zoom_factor);
end;
