...
for iz = 1 : size(V,3)
    for iy = 1 : size(V,2)
        for ix = 1:size(V,1)
         ...
         if ((temp(1,1)>0) && (temp(2,1)>0) && (temp(3,1)>0) && (temp(1,1)<size(V,1)) && (temp(2,1)<size(V,2)) && (temp(3,1)<size(V,3)))
...
[fx,fy,fz] = getsign(VV,meanx,meany,meanz,0)
    ...
    for iy = 1 : size(V1,2)
        for ix = 1:size(V1,1)
            ...
            if ( temp(3,1) == 0)
             ...
             if ((temp(1,1)>0) && (temp(2,1)>0) && (temp(3,1)>0) && (temp(1,1)<size(V1,1)) && (temp(2,1)<size(V1,2)) && (temp(3,1)<size(V1,3)))
              VV1(temp(1,1),temp(2,1),temp(3,1)) = V1(ix,iy,iz);
             end
        end
    end
end
[fx1,fy1,fz1] = getsign(VV1,meanx1,meany1,meanz1,0)
