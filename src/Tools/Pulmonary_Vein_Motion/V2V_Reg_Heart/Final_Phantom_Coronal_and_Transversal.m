...
%%%%%%%%%%%%%%%%%%%%%%%%informations%%%%%%%%%%%%%%%%%%%%%
[V aR aT spacing info AngM OrM] = get_image(763,112/2,'C:\ThirdParty\RawData\Grimaldi\',0);%7291579
...
[Vi bR bT spacing1 info1 AngM1 OrM1] = get_image(557,120,'C:\ThirdParty\RawData\Grimaldi\',0);
