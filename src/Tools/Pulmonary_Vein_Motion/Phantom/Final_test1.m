...
%              temp1mm(3,1) = ((tempTwo(3,1)-CCz1)/spacing1(3,1))+1;
             ...
             temp1(1,1) = round((tempTwo(1,1)-OrgAli2(1,1))/spacing1(1,1))+1;
             temp1(2,1) = round((tempTwo(2,1)-OrgAli2(2,1))/spacing1(2,1))+1;
             temp1(3,1) = round((tempTwo(3,1)-OrgAli2(3,1))/spacing1(3,1))+1;
