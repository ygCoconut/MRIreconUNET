...
%%%%%%%%%%%%%%%%%%%%%%%%informations%%%%%%%%%%%%%%%%%%%%%
[V aR aT spacing info AngM OrM] = get_image(1273,33,'C:\ThirdParty\RawData\Mehdi_Phantom1\',0);%7291579
...
[Vi bR bT spacing1 info1 AngM1 OrM1] = get_image(1443,33,'C:\ThirdParty\RawData\Mehdi_Phantom1\',0);
