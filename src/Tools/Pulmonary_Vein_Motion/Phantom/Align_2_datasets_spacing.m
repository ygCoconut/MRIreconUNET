...
% [V1 bR bT spacing] = get_image(763,112/2,'C:\ThirdParty\RawData\Grimaldi\',1);
% Rb = [bR(1:3),bR(4:6)];
...
for iz = 1 : 2*size(V1,3)
     for iy = 1 : round(sqrt(2)*size(V1,2))
         for ix = 1: round(sqrt(2)*size(V1,1))
             ...
             temp1 = rotateM([ -72.2478   16.6665   48.1439])'*(temp-[meanx1;meany1;meanz1])+[meanx1;meany1;meanz1];
