...
clc
clear
info = dicominfo('D:\DICOM\00000003\IM_0001','dictionary','dicom-dict-philips.txt');
Yor = dicomread(info);
...
%5C=normxcorr2(Y2,Y1);
 ...
 for i = 1 : 56
     if ( i <10 )
         File_Name = 'C:\Program Files\MATLAB71\work\Pulmonary_Vein_Motion\Images\00000003\IM_000';
     elseif (i < 100)
         File_Name = 'C:\Program Files\MATLAB71\work\Pulmonary_Vein_Motion\Images\00000003\IM_00';
     elseif (i < 1000)
         File_Name = 'C:\Program Files\MATLAB71\work\Pulmonary_Vein_Motion\Images\00000003\IM_0';
     else
         File_Name = 'C:\Program Files\MATLAB71\work\Pulmonary_Vein_Motion\Images\00000003\IM_';
     end
% 
